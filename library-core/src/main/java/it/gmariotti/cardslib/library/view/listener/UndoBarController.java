...
public class UndoBarController {
    ...
    public interface UndoBarUIElements{
         ...
         * Use the {@link it.gmariotti.cardslib.library.view.listener.UndoBarController.UndoBarUIElements.AnimationType#ALPHA} for an alpha animation, or {@link it.gmariotti.cardslib.library.view.listener.UndoBarController.UndoBarUIElements.AnimationType#TOPBOTTOM} for a translation from bottom to top.
         */
         ...
         *  <p/>
         *  You can use {@link it.gmariotti.cardslib.library.view.listener.UndoBarController.UndoBarUIElements.SwipeDirectionEnabled#NONE}  to disable the swipe action or  {@link it.gmariotti.cardslib.library.view.listener.UndoBarController.UndoBarUIElements.SwipeDirectionEnabled#LEFTRIGHT} to enable an action in left-right direction
         *  or {@link it.gmariotti.cardslib.library.view.listener.UndoBarController.UndoBarUIElements.SwipeDirectionEnabled#TOPBOTTOM} to define a swipe action from top to bottom.
         */
