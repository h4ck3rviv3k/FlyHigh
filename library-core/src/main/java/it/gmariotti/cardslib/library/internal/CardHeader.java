 ...
 * </p>
 * You can attach a Popup Menu to overflowMenu with {@link #setPopupMenu(int, it.gmariotti.cardslib.library.internal.CardHeader.OnClickCardHeaderPopupMenuListener)}
 * <pre><code>
 ...
 * </code></pre>
 * </p>
 * You can attach a {@link it.gmariotti.cardslib.library.internal.CardHeader.OnClickCardHeaderOtherButtonListener} to button to listen any callback when
...
public class CardHeader extends BaseCard {
     ...
     * You can use a xml layout with {@link it.gmariotti.cardslib.library.internal.CardHeader#setInnerLayout(int)} or with constructor
     * {@link it.gmariotti.cardslib.library.internal.CardHeader#CardHeader(android.content.Context, int)}.
     *
